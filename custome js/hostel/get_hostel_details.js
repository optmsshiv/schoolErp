        ...
        data.data.forEach((row) => {
          ...
          tr.innerHTML = `
                        <tr>
                            ...
                            <td>
                              <button class="btn btn-warning btn-sm edit-hostel" data-user-id="${row.student_id}">Edit</button>
                              <button class="btn btn-danger btn-sm remove-hostel" data-user-id="${row.student_id}">Remove</button>
                            </td>
